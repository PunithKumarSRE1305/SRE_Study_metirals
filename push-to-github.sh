...
REPO_URL="https://github.com/PunithKumarSRE1305/SRE_Study_metirals.git"
...
git clone "$REPO_URL" SRE-Study-materials-temp
cd SRE-Study-materials-temp
...
echo ""
echo "Next steps:"
echo "1. Go to: https://github.com/PunithKumarSRE1305/SRE_Study_metirals"
